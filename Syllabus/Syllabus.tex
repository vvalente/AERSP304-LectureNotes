...
\title{AERSP304 - Dynamics and Control of \\ Aerospace Systems, Section 002 \\ {\fontsize{14pt}{16pt}\selectfont SP26, MWF 10:10AM-11:00AM, ECoRE Bldg 102}}
\author{}
\date{}
...
This is a required text for this class and is available at University book store. You can buy 7th or 8th edition of the book and you may want to check the price at online vendors before purchasing it at bookstore.
...
\tagstructbegin{tag=Part}%required to ensure correct reading order of contents if the table
\begin{table}[H]
    \centering
    ...
    \begin{tabular}{p{4cm}|p{2cm}|p{2cm}|p{6.5cm}}
        ...
        \textbf{Homework Quizzes: }& 20\% & 20\%& 6-7 in the semester\\
...
\subsubsection*{Projects:} Three group projects will be assigned during the semester, involving both analytical and numerical work, including computer programming. Groups may have up to three students. Each group will submit one project report/solution and a corresponding set of computer codes. The report should include problem formulation, solution methodology, results and discussion. Academic dishonesty, including copying solutions or code, violates the University honor code.
Late submissions will incur a 10\% penalty per day. Special exceptions will be considered only if the instructor is contacted at least one day before the project due date.
...
\section*{Military Accommodations}
...
\section*{Educational Equity and Reporting Bias}
Penn State takes great pride to foster a diverse and inclusive environment for students, faculty, and staff. Acts of intolerance, discrimination, or harassment due to age, ancestry, color, disability, gender, gender identity, national origin, race, religious belief, sexual orientation, or veteran status are not tolerated and can be reported through Educational Equity via the Report Bias webpage (http://equity.psu.edu/reportbias/).
